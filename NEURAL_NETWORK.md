...
# And a reversed mRNA sequence like "xxxxxxxxxxGxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
mi_seq_slice = mi_seq[:10]           # Take first 10 nt: "AGCUGCCAAU"
cts_r_seq_slice = cts_r_seq[5:15]    # Take nt 5-15 (includes mutation at pos 10): "xxxxxGxxxx"
...
# Example result:
# mi_esa = "AGCUGCCAAU"
# cts_r_esa = "CAGC-AGCUA"  (a gap was introduced)
```
